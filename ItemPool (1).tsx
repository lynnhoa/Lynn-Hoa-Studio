  ...
  return(
    <div>
      ...
      <div style={{border:`1px solid ${C.rule}`,borderRadius:2,marginBottom:12}}>
        ...
        {items.map((it: any)=>{
          const priceVal = draft && editId===it.id ? String(draft.p||"").replace("null","") : "";
          return(
            ...
            {editId===it.id&&draft?(
              ...
              <div style={{padding:"10px 12px"}}>
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 80px",gap:8,marginBottom:8}}>
                  ...
                  <div><Lbl>Price (€)</Lbl><I type="number" value={priceVal} onChange={(e: any)=>setDraft((p: any)=>({...p,p:e.target.value====""?null:parseFloat(e.target.value)||0}))}/></div>
                </div>
